...
import 'package:flutter_ecommerce/controller/auth/verifycodesignup_controller.dart';
...
class VerfiyCodeSignUpScreen extends StatelessWidget {
  const VerfiyCodeSignUpScreen({Key? key}) : super(key: key);
